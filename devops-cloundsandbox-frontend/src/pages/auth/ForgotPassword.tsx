...
const ForgotPassword = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(err.response?.data?.message || "Failed to send reset link. Verify your email.");
    } finally {
      setIsLoading(false);
    }
  };
        ...
        {!isSent ? (
          <>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button disabled={isLoading} className="w-full bg-blue-600 hover:bg-blue-500 text-white font-bold py-3 rounded-xl flex justify-center items-center gap-2 shadow-lg shadow-blue-600/20 transition-all disabled:opacity-50">
          ...
          <div className="text-center py-4 animate-in fade-in zoom-in duration-500">
            ...
            <button onClick={() => setIsSent(false)} className="text-blue-500 text-sm font-bold hover:text-blue-400">
