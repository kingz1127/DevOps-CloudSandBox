...
//                 <div className="bg-white h-2 rounded-full" style={{ width: `${(totalCompleted / 4) * 100}%` }}></div>
//               </div>
//               <span className="text-[10px] font-bold uppercase">{totalCompleted}/4 Modules</span>
//             </div>
